...
export default function SuppliesProductPage({ params }: ProductPageProps) {
          ...
          >
            <nav className="mb-6">
              <ol className="flex items-center gap-2 text-sm flex-wrap">
                ...
                <li><Link href="/supplies" className="text-default-500 hover:text-default-900">Supplies</Link></li>
                <li className="text-default-400">/</li>
                <li><Link href={`/supplies/${categoryId}`} className="text-default-500 hover:text-default-900">{category.name}</Link></li>
                <li className="text-default-400">/</li>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 bg-default-100 rounded-lg">
                      ...
                      <div>
                        ...
                        <Link href={`/supplies/${categoryId}`} className="text-primary font-medium">
                          {category.name}
                        </Link>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-default-600">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Wide selection of high-quality medical imaging supplies</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>Expert support and product recommendations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
              ...
              <CardBody>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {category.subcategories.filter((sub) => sub.id !== productId).slice(0, 6).map((relatedProduct) => (
                    <Link key={relatedProduct.id} href={`/supplies/${categoryId}/${relatedProduct.id}`} className="group">
