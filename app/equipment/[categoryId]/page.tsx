...
/**
 * Dynamic Equipment Category Page
 * 
 * Shows all subcategories/products within a specific equipment category.
 * Provides detailed view with all products, external links, and ordering info.
 */
