              ...
              <CardBody className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-default-600">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>Fast shipping and emergency part availability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>Quality guarantee on all replacement parts</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">✓</span>
                      <span>
          ...
          <aside className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-primary-50 to-secondary-50">
              <CardBody className="space-y-3">
                ...
                <p className="text-sm text-default-600">
                  Our experienced parts team can help you with:
                </p>
                <ul className="text-sm text-default-600 space-y-1">
                  <li>• Part identification & compatibility</li>
