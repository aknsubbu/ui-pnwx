...
/**
 * Dynamic Parts Category Page
 */
export default function PartsCategoryPage({ params }: CategoryPageProps) {
          ...
          >
            ...
            <nav className="mb-6">
              <ol className="flex items-center gap-2 text-sm">
                ...
                <li>
                  <Link href="/parts" className="text-default-500 hover:text-default-900">
                    Parts
                  </Link>
                </li>
                <li className="text-default-400">/</li>
